...
describe("Teste para a home", () => {
  ...
  it("Deve incluir informações no formulário", () => {
    cy.get('input[type="text"]').type("Renato Pinheiro"); // Preencher o campo de nome
    cy.get('input[type="email"]').type("renato@gmail.com"); // Preencher o campo de e-mail
    cy.get('input[type="tel"]').type("31999999999"); // Preencher o campo de telefone
  ...
  it("Deve alterar a informação da lista", () => {
    ...
    cy.get('input[type="text"]').clear().type("Roberto Carlos"); // Limpar e preencher o campo de nome
    cy.get('input[type="email"]').clear().type("roberto@ebac.com.br"); // Limpar e Preencher o campo de e-mail
    cy.get('input[type="tel"]').clear().type("31888888888"); // Limpar e Preencher o campo de telefone
